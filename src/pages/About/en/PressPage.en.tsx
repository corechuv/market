...
export default function PressPageEn() {
    ...
    return (
        <>
            <Helmet>
                <title>Press – Dashedo</title>
                <meta
                    name="description"
                    content="Press resources for Dashedo: company facts, boilerplate, media contact and downloadable press kit."
                />
                <link rel="canonical" href="https://dashedo.com/about/press" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Press – Dashedo" />
                <meta
                    property="og:description"
                    content="Press area for Dashedo with company overview, boilerplate and media contact."
                />
                <meta property="og:url" content="https://dashedo.com/about/press" />
                <meta name="twitter:card" content="summary" />
                <meta name="twitter:title" content="Press – Dashedo" />
                <meta
                    name="twitter:description"
                    content="Press resources, boilerplate text and media contact for Dashedo."
                />
            </Helmet>
            <Page>
