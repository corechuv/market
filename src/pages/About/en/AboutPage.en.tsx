...
export default function AboutPageEn() {
    ...
    return (
        <>
            <Helmet>
                <title>About Dashedo – Who we are</title>
                <meta
                    name="description"
                    content="Learn more about Dashedo: our mission, team, and how we build software to simplify complex workflows."
                />
                <link rel="canonical" href="https://dashedo.com/about" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="About Dashedo – Who we are" />
                <meta
                ...
                <meta name="twitter:title" content="About Dashedo – Who we are" />
                <meta
