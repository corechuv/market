...
export default function AboutPageRu() {
    ...
    return (
        <>
            <Helmet>
                <title>О нас – Dashedo</title>
                <meta
                    name="description"
                    content="Узнайте больше о Dashedo: нашу миссию, команду и то, как мы упрощаем сложные рабочие процессы."
                />
                <link rel="canonical" href="https://dashedo.com/about" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="О нас – Dashedo" />
                <meta
                ...
                <meta name="twitter:title" content="О нас – Dashedo" />
                <meta
