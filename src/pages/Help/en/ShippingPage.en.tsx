...
export default function ShippingPageEn() {
    ...
    const title = "Provisioning & Delivery (digital) – Help | Dashedo";
    const description =
        "Learn how access to Dashedo is provisioned, what to do if emails do not arrive, and how availability and billing work.";
