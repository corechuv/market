// src/pages/Help/de/ReturnsRefundsPage.de.tsx
import "react"
import { Helmet } from "react-helmet-async"
import Page from "../../../components/UI/Page/Page"
import s from "../Help.module.scss"

export default function ReturnsRefundsPageDe() {
    const jsonLd = {
    ...
    const title = "Rückgaben & Erstattungen – Hilfe | Dashedo";
    const description =
        "Informationen zu Rückgaben, Widerrufsrecht und Erstattungen bei Dashedo für Verbraucher und Geschäftskunden.";
