...
export default function ImprintPageRu() {
    ...
    const title = "Импрессум (выходные данные) – Правовая информация | Dashedo";
    const description =
        "Импрессум Dashedo GmbH: информация о компании, контактные данные, регистрация в торговом реестре, номер НДС и юридические уведомления.";
