...
export default function ImprintPageDe() {
    ...
    const title = "Impressum – Rechtliches | Dashedo";
    const description =
        "Impressum der Dashedo GmbH: Anbieterkennzeichnung, Kontakt, Registerangaben, Haftungshinweise und rechtliche Informationen.";
