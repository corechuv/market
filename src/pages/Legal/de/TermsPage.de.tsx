...
export default function TermsPageDe() {
    ...
    const title = "Allgemeine Geschäftsbedingungen (AGB) – Dashedo";
    const description =
        "Allgemeine Geschäftsbedingungen für die Nutzung der digitalen Dienste von Dashedo auf dashedo.com.";
    ...
    return (
        <>
            <Helmet>
                ...
                <link rel="canonical" href="https://dashedo.com/legal/terms" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content={title} />
                <meta property="og:description" content={description} />
                <meta property="og:url" content="https://dashedo.com/legal/terms" />
