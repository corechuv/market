...
export default function CookiePolicyPageEn() {
    ...
    const title = "Cookie Policy – Legal | Dashedo";
    const description =
        "Learn how Dashedo uses cookies and similar technologies, on which legal basis, and how you can manage or withdraw your consent.";
