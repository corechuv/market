...
export default function PrivacyPolicyPageEn() {
    ...
    const title = "Privacy Policy – Legal | Dashedo";
    const description =
        "Privacy Policy of Dashedo GmbH: how we process personal data, legal bases under the GDPR, retention periods and your data subject rights.";
