...
import type { ReturnRequest, ReturnItemLine, ReturnKind, ReturnReason, RefundDestination } from "../../types/return";
...
export default function ReturnRequestPage() {
  ...
  function submit() {
    ...
    const refund: RefundDestination = order.payment
      ? { kind: "original" as const, method: order.payment.method, label: paymentMethodLabel(order.payment.method) }
      : { kind: "store_credit" as const, label: "Store credit" };
      ...
      <PageLayout title="Order not found" onBack={() => navigate(-1)}>
        <div className={styles.card}>
          <div className={styles.cardHeader}>
            ...
            <p className={styles.muted}>Open your order and click "Return" to submit your request.</p>
          </div>
