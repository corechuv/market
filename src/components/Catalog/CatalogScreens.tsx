  ...
  <div className={c.content}>
    ...
    <div className={c.drawer}>
      ...
      <div className={p.screenClass("L1", c)}>
        <ScrollArea lockBody={p.stage === "L1"} ref={p.refs.l1 as any}>
          {p.isLoading ? (
      ...
      >
        <ScrollArea lockBody={p.stage === "L2"} ref={p.refs.l2 as any}>
          {p.rootCat && (
            <ul className={c.list}>
              <li
                className={c.list__item}
      ...
      <div
        ...
        onTouchEnd={p.touch.onTouchEnd}
      >
        <ScrollArea lockBody={p.stage === "L3"} ref={p.refs.l3 as any}>
          {p.l2Cat && (
            <ul className={c.list}>
              <li
                className={c.list__item}
