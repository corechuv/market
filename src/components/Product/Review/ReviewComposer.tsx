...
export default function ReviewComposer({ productId }: Props) {
    const [mode, setMode] = React.useState<"choose" | "plain" | "reel">("choose"); // новый экран выбора
    ...
    const Controls = (
        <>
            ...
            <TextareaField
                label="Name"
                placeholder={
                    isReel ? "Description" : "Description"
                }
                value={text}
    ...
    return (
        <div className={styles.root}>
            {/* Верхняя панель с кнопкой назад (видна в режимах plain|reel) */}
            {mode !== "choose" && (
